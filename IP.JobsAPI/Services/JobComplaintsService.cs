...
{
    public class JobComplaintsService : IJobComplaintsRepository
    {
        private SqlConnection myconn;
        private GlobalServiceMethods gs;
        public JobComplaintsService()
        {
        ...
        public List<JobComplaints> GetJobComplaintsDetailsAsync(int ID, int jobId)
        {
            try
            {
                ...
                sqlCmd.CommandText = "SP_JobComplaintsGet";
                sqlCmd.Parameters.Add(new SqlParameter("@ID", ID));
                sqlCmd.Parameters.Add(new SqlParameter("@jobId", jobId));

                sqlCmd.Connection = myconn;
                reader = sqlCmd.ExecuteReader();
                List<JobComplaints> lst = new List<JobComplaints>();
                while (reader.Read())
                {
                    lst.Add(new JobComplaints()
                    {
                        Id = Convert.ToInt32(reader.GetValue(0)),
                        jobID = Convert.ToInt32(reader.GetValue(1)),
                        compliantDesc = reader.GetValue(2).ToString(),
        ...
        public void InsertJobComplaintsDetailsAsync(JobComplaints jobAssign)
        {
            if (myconn.State != ConnectionState.Open)
                myconn.Open();
            ...
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandText = "SP_JobComplaintsInsertUpdate";
            ...
            sqlCmd.Parameters.Add(new SqlParameter("@compliantDesc", jobAssign.compliantDesc));
            ...
            try
            {
               ...
               // InsertJobComplaintsRateDetailsAsync(JobComplaintsRates, JobComplaints.JobComplaintsID, tran);
                tran.Commit();
        ...
        public void UpdateJobComplaintsDetailsAsync(JobComplaints jobAssign)
        {
            if (myconn.State != ConnectionState.Open)
                myconn.Open();
            ...
            try
            {
              ...
              //  UpdateJobComplaintsRatesDetailsAsync(JobComplaintsRates, tran);
                tran.Commit();
        ...
        public void DeleteJobComplaintsDetailsAsync(int ID)
        {
            if (myconn.State != ConnectionState.Open)
                myconn.Open();
            ...
            SqlCommand sqlCmd = new SqlCommand();
            sqlCmd.CommandType = CommandType.StoredProcedure;
            sqlCmd.CommandText = "SP_JobComplaintsDelete";
            sqlCmd.Parameters.Add(new SqlParameter("@ID", ID));
